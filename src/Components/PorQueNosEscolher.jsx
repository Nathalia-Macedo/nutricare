...
//   return (
//     <div className="relative bg-green-600 pt-16 pb-24">
...
//             </div>
//             <h3 className="text-xl font-semibold text-white mb-3">Atendimento Personalizado</h3>
//             <p className="text-white/90">Planos nutricionais adaptados às suas necessidades e objetivos específicos.</p>
//           </div>
...
//             </div>
//             <h3 className="text-xl font-semibold text-white mb-3">Experiência Comprovada</h3>
//             <p className="text-white/90">Anos de prática clínica e formação acadêmica de excelência.</p>
//           </div>

//           {/* Card 3 */}
//           <div className="lg:col-span-1 md:col-span-2 bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center mx-auto w-full">
//             <div className="flex justify-center mb-4">
//               <Users className="w-12 h-12 text-white" />
//             </div>
//             <h3 className="text-xl font-semibold text-white mb-3">Abordagem Holística</h3>
//             <p className="text-white/90">Consideramos todos os aspectos da sua saúde e estilo de vida.</p>
//           </div>
//         </div>
//       </div>
