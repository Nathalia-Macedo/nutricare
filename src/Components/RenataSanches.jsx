...
function RenataSection() {
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-8 py-8 flex flex-col md:flex-row gap-8 md:gap-12">
      <div className="relative flex-1 md:-ml-8 hidden md:block">
        <img
      ...
      <div className="flex-1 space-y-6">
        ...
        <p className="text-gray-600">
          Conheça nossa equipe de nutricionistas altamente qualificadas, dedicadas a proporcionar o melhor atendimento e
          orientação nutricional personalizada para você.
        </p>
